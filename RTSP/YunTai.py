...
import configparser
import cv2
from RTSP.getRtspByRegion import getRtsp
...
'''
def setCameraZoom(cameraIndex,x1,y1,x2,y2,w=1920,h=1080):
    x1 = x1 / w * 255
    y1 = y1 / h * 255
    x2 = x2 / w * 255
    y2 = y2 / h * 255
    ...
    cf.read(r"C:\Users\Administrator\Desktop\jczx\RTSP\ApiConfig.ini")  # 读取ApiConfig.ini配置文件
...
if __name__ == '__main__':
    ...
    print(time)
    # cameraIndex="37170310411319506416"
    ...
    #         ret,img=cap.read()
    #         # if a%25==0:
    #         cv2.imwrite('./img/'+str(a)+".jpg",img)
    #         if a==500:
    #             info = setCameraZoom(cameraIndex, x1, y1, x2, y2, w, h)
