...
def getSubRegion(regionIndex):
    ...
    host = "https://10.67.223.171"  # 获取[api-config]中host对应的值
    port =9785  # 获取[api-config]中port对应的值
    ...
    # Step3：组装POST请求URL
    # Setting Url
    url = host +':' + str(port) +'/' +"/kdr/kay:dsc:1.0/services/single/getYjSs.json"
    ...
    payload={
        "body": [],
        "head": {"username":"jczx","password":"Jczx#2021","startDate.t":"2017-06-26 07:45:10","endDate.t":"2017-07-06 07:45:10","jh.s":"XHH159-X26"},
    }
